<script>
	export let alertType; //currently danger and success
	export let title;
...
>
	{#if alertType === 'danger'}
		<div
			...
			class="p-4 mb-4 text-red-800 align-middle border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
			role="alert"
		>
